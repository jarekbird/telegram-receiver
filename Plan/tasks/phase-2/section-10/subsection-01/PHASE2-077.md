...
Convert create telegrammessagejob processor class from Rails to TypeScript/Node.js. Reference `jarek-va/app/jobs/telegram_message_job.rb`.

## Checklist

- [ ] Create `src/jobs/telegram-message-job.ts` file
- [ ] Extend base job processor
- [ ] Define job name constant
