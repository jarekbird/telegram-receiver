...
Convert implement send_text_as_audio method from Rails to TypeScript/Node.js. Reference `jarek-va/app/jobs/telegram_message_job.rb`.

## Checklist

- [ ] Create `sendTextAsAudio` method
- [ ] Check if audio output enabled
